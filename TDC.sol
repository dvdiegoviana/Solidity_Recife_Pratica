/*
Implements EIP20 token standard: https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md with escrow example
.*/
...
contract TDC is EIP20Interface {
        ...
        */
        ...
        function buy(address _seller, uint256 _value) public returns (bool success) {
            require(balances[msg.sender] >= _value);
            balances[msg.sender] -= _value;
            balances[escrow] += _value;
            pendingSales[++nextSaleID] = PendingSale(_seller, msg.sender, _value);
